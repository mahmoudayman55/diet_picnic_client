...
class VideoWidget extends StatelessWidget {
  ...
  VideoWidget(this.video, {super.key});
      ...
      child: IntrinsicHeight(
        child: Stack(
          children: [
            ...
            ),    if (!video.availableForAll&&(!UserController.to.isLoggedIn||!UserController.to.isSubscribed))
              Container(
                ...
                children: [
                  ...
                  SizedBox(height: 8,),
                  Text("هذا المحتوى متاح للمشتركين فقط",style: Theme.of(context).textTheme.displayMedium!.copyWith(color: Colors.white),textAlign: TextAlign.center,)
                ],
              ),
              ),
          ],
